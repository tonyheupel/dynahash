...
Gem::Specification.new do |s|
  ...
  s.description = 'Dynahash allows you to access Hash keys as if they were properties. For example:  h = {:first_name => "Tony", "**the gender**" => :male};  h.name;  # => "Tony"  h.the_gender # => :male'
